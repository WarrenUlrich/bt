...
namespace bt {
  ...
  class selector_node {
  public:
    constexpr selector_node(const Nodes &...nodes) : _nodes(std::make_tuple(nodes...)) {}

    constexpr selector_node(Nodes &&...nodes) : _nodes(std::make_tuple(std::move(nodes)...)) {}
  ...
  template<typename Context, BehaviorNode<Context>... Nodes>
  constexpr selector_node<Context, Nodes...> make_selector_node(const Nodes &...nodes) {
    return selector_node<Context, Nodes...>(nodes...);
  }

  template<typename Context, BehaviorNode<Context>... Nodes>
  constexpr selector_node<Context, Nodes...> make_selector_node(Nodes &&...nodes) {
